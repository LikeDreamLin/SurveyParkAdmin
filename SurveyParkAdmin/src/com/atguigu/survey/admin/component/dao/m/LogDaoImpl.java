...
public class LogDaoImpl extends BaseDaoImpl<Log> implements LogDao{
	...
	public List<String> getAllTableNames() {
		...
		String sql = "SELECT table_name FROM information_schema.`TABLES` WHERE TABLE_NAME LIKE 'logs_%' AND TABLE_SCHEMA='survey1022'";
	...
	public List<Log> getLimitedLogList(int pageNo, int pageSize) {
		...
		for (Object[] objects : result) {
			...
			Log log = new Log(logId, operator, operateTime, methodType, methodName, methodArgs, methodReturnValue, methodResultMsg);

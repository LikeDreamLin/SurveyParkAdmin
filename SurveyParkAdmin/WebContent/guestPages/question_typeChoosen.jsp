			...
			<table class="formTable">
				...
				<tr>
					...
					<td style="text-align: left;">
						...
						<br/>
						<input id="radio03" type="radio" name="questionType" value="2"
							<s:if test="questionType == 2">checked="checked"</s:if>
						/>
						<label for="radio03">下拉列表选择题</label>
						<br/>
						<input id="radio04" type="radio" name="questionType" value="3"
							<s:if test="questionType == 3">checked="checked"</s:if>
						/>
						<label for="radio04">简答题</label>
						<br/>
						<input id="radio05" type="radio" name="questionType" value="4"
							<s:if test="questionType == 4">checked="checked"</s:if>
						/>
						<label for="radio05">矩阵单选题</label>
						<br/>
						<input id="radio06" type="radio" name="questionType" value="5"
							<s:if test="questionType == 5">checked="checked"</s:if>
						/>
						<label for="radio06">矩阵多选题</label>
						<br/>
						<input id="radio07" type="radio" name="questionType" value="6"
							<s:if test="questionType == 6">checked="checked"</s:if>
						/>
						<label for="radio07">矩阵下拉列表选择题</label>
						<br/>
					</td>
				</tr>
				<tr>

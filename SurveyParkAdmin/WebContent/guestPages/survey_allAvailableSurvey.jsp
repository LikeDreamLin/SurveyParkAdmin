...
<body>
	...
	<div class="block-div">
		<table class="dashedTable">
			...
			<s:if test="(#myStatus.index % 5 == 0) && (#myStatus.count < list.size())">
				<tr>
			</s:if>
					<td align="center">
						...
						<br/>
						<s:a namespace="/Guest" action="EngageAction_entry?surveyId=%{surveyId}"><s:property value="title"/></s:a>
					</td>
			<s:if test="(#myStatus.count % 5 == 0) || (#myStatus.count == list.size())">
				</tr>
			</s:if>
			</s:iterator>
			</s:else>
			...
			<tr>
				<td colspan="5" align="center">
					...
					<s:set value="'SurveyAction_findAllAvailableSurvey'" var="pageActionName"/>

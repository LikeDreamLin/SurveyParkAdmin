	...
	<div class="block-div">
		<table class="dashedTable">
			<tr>
				...
				<td class="rightTd">
					<s:a namespace="/Guest" action="SurveyAction_myCompletedSurveyList">查看详情</s:a>
				</td>
			</tr>
			<tr>
				<td class="leftTd">我参与的调查</td>
				<td class="rightTd">
					<s:a namespace="/Guest" action="SurveyAction_myEngagedSurvey">查看详情</s:a>
				</td>
			</tr>
			<tr>
				<td class="leftTd">未完成的调查</td>
				<td class="rightTd">
					<s:a namespace="/Guest" action="SurveyAction_myUncompleted">查看详情</s:a>
				</td>
			</tr>
		</table>
	</div>
